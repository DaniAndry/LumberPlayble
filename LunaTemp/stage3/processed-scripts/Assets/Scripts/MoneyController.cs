...
public class MoneyController : MonoBehaviour
{
    ...
    public void ChangeBalance(int money, bool isSpending, [Bridge.Ref] Vector3 position)
    {
        if (!isSpending)
        {
            _moneyBalance.SetMoney(money);
    ...
    public void ChangeBalanceWithVisual(int money, [Bridge.Ref] Vector3 worldStartPosition, bool isSpending = false)
    {
    ...
    public void ChangeBalanceWithVisual(int money, RectTransform uiStartElement, [Bridge.Ref] Vector3 worldTarget,
