...
if ( TRACE ) { TRACE( "BuildManager#Awake", this ); }
                ...
                this._buildButton2.onClick.AddListener(Bridge.fn.bind(this, function () {
                    this._moneyController.TryBuild(12, this._build2);
                }));
                this._buildButton3.onClick.AddListener(Bridge.fn.bind(this, function () {
                    this._moneyController.TryBuild(125, this._build3);
                }));
            },
            /*BuildManager.Awake end.*/

            /*BuildManager.TryToBuild start.*/
            TryToBuild: function (price) {
if ( TRACE ) { TRACE( "BuildManager#TryToBuild", this ); }

                this._moneyController.ChangeBalance(price, true);
                return null;
            },
            /*BuildManager.TryToBuild end.*/
...
if ( TRACE ) { TRACE( "CharactersMover#Start", this ); }
                ...
                this.initialRotationX = this.transform.rotation.getPositiveEulerAngles().x;
                this.initialRotationZ = this.transform.rotation.getPositiveEulerAngles().z;
                UnityEngine.Debug.Log(this.character);
...
if ( TRACE ) { TRACE( "CharactersMover#MoveToNextPoint", this ); }
                ...
                if (!pc.Vec3.equals( lookDirection, pc.Vec3.ZERO.clone() )) {
                    ...
                    var finalRotation = new pc.Quat().setFromEulerAngles_Unity( this.initialRotationX, yRotation, this.initialRotationZ );
                ...
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, targetPos.$clone(), moveDuration), DG.Tweening.Ease.InOutSine), Bridge.fn.bind(this, function () {
                    if (UnityEngine.Component.op_Inequality(this.animator, null)) {
                        if (Bridge.is(currentPoint, LoadPoint)) {
                            this.animator.Play$2("Load");
                        } else {
                            if (Bridge.is(currentPoint, UnloadPoint)) {
                                this.character.Unload();
                            }
                        }
                        this.animator.Play$2("Unload");
                        UnityEngine.Debug.Log(currentPoint);
                    }

                    this.currentPointIndex = (this.currentPointIndex + 1) | 0;
...
if ( TRACE ) { TRACE( "MoneyController#TryBuild", this ); }
                ...
                if (this._moneyBalance.Money >= price) {
                    ...
                    UnityEngine.Debug.Log$1("\u041d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u0434\u0435\u043d\u0435\u0433 \u0434\u043b\u044f \u0441\u0442\u0440\u043e\u0438\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u0430.");
                }
            },
...
if ( TRACE ) { TRACE( "Tree#Take", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","UnityEngine.UI","System.Collections.Generic","TMPro","DG.Tweening","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*BuildManager start.*/
    $m("BuildManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"TryToBuild","t":8,"pi":[{"n":"price","pt":$n[0].Int32,"ps":0}],"sn":"TryToBuild","rt":Function,"p":[$n[0].Int32]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_build1","t":4,"rt":$n[1].GameObject,"sn":"_build1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_build2","t":4,"rt":$n[1].GameObject,"sn":"_build2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_build3","t":4,"rt":$n[1].GameObject,"sn":"_build3"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_buildButton1","t":4,"rt":$n[2].Button,"sn":"_buildButton1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_buildButton2","t":4,"rt":$n[2].Button,"sn":"_buildButton2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_buildButton3","t":4,"rt":$n[2].Button,"sn":"_buildButton3"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_moneyController","t":4,"rt":MoneyController,"sn":"_moneyController"}]}; }, $n);
    /*BuildManager end.*/

    /*Garage start.*/
    $m("Garage", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"car","t":4,"rt":$n[1].GameObject,"sn":"car"}]}; }, $n);
    /*Garage end.*/

    /*Character start.*/
    $m("Character", function () { return {"att":1048705,"a":2,"m":[{"a":3,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"TakeTree","t":8,"pi":[{"n":"tree","pt":Tree,"ps":0}],"sn":"TakeTree","rt":$n[0].Void,"p":[Tree]},{"a":2,"n":"Unload","t":8,"sn":"Unload","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_cargo","t":4,"rt":$n[3].List$1(UnityEngine.GameObject),"sn":"_cargo"},{"a":1,"n":"_currentCargoIndex","t":4,"rt":$n[0].Int32,"sn":"_currentCargoIndex","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"_isFull","t":4,"rt":$n[0].Boolean,"sn":"_isFull","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"OnCargoFull","t":2,"ad":{"a":2,"n":"add_OnCargoFull","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"addOnCargoFull","rt":$n[0].Void,"p":[Function]},"r":{"a":2,"n":"remove_OnCargoFull","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"removeOnCargoFull","rt":$n[0].Void,"p":[Function]}}]}; }, $n);
    /*Character end.*/

    /*CharactersMover start.*/
    $m("CharactersMover", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"MoveToNextPoint","t":8,"sn":"MoveToNextPoint","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"animator","t":4,"rt":$n[1].Animator,"sn":"animator"},{"a":1,"n":"character","t":4,"rt":Character,"sn":"character"},{"a":1,"n":"currentPointIndex","t":4,"rt":$n[0].Int32,"sn":"currentPointIndex","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"initialRotationX","t":4,"rt":$n[0].Single,"sn":"initialRotationX","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"initialRotationZ","t":4,"rt":$n[0].Single,"sn":"initialRotationZ","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("\u0422\u043e\u0447\u043a\u0438 \u043c\u0430\u0440\u0448\u0440\u0443\u0442\u0430"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"movePoints","t":4,"rt":System.Array.type(MovePoint),"sn":"movePoints"}]}; }, $n);
    /*CharactersMover end.*/
    ...
    /*UnloadPoint start.*/
    $m("UnloadPoint", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"}]}; }, $n);
    /*UnloadPoint end.*/

    /*Tree start.*/
    $m("Tree", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Take","t":8,"sn":"Take","rt":$n[0].Void}]}; }, $n);
    /*Tree end.*/
